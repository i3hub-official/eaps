...
export const actions: Actions = {
  seed: async ({ locals }) => {
    ...
    try {
      ...
      const s1 = D(16,6,2026,23,0), e1 = D(20,6,2026,23,59);
      const s2 = D(16,6,2026,23,0), e2 = D(20,6,2026,23,59);
      ...
      const exam1 = await prisma.exam.upsert({ where: { id: EXAM_ID_1 }, update: {}, create: {
      ...
      const exam2 = await prisma.exam.upsert({ where: { id: EXAM_ID_2 }, update: {}, create: {
      ...
      const exam3 = await prisma.exam.upsert({ where: { id: EXAM_ID_3 }, update: {}, create: {
      ...
      const exam4 = await prisma.exam.upsert({ where: { id: EXAM_ID_4 }, update: {}, create: {
      ...
      const exam5 = await prisma.exam.upsert({ where: { id: EXAM_ID_5 }, update: {}, create: {
      ...
      const exam6 = await prisma.exam.upsert({ where: { id: EXAM_ID_6 }, update: {}, create: {
