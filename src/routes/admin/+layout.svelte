          ...
          <div class="nav-group-wrap" class:child-active={childActive}>
            ...
            >
              ...
              <ChevronDown
                size={13}
                class="nav-chevron"
                style="transform: rotate({isExpanded ? '180deg' : '0deg'}); transition: transform .2s;"
              />
            </button>
    ...
    <header class="topbar">
      ...
      <div class="topbar-right">
        ...
        <div class="notif-wrap">
          <button
            class="icon-btn"
            onclick={() => { notificationsOpen = !notificationsOpen; userMenuOpen = false; }}
          ...
          {#if notificationsOpen}
            <div class="notif-panel">
              <div class="notif-head">
                Notifications
                <button onclick={() => notificationsOpen = false}><X size={14} /></button>
              </div>
        ...
        <div class="user-menu-wrap">
          <button
            ...
            onclick={() => { userMenuOpen = !userMenuOpen; notificationsOpen = false; }}
          >
