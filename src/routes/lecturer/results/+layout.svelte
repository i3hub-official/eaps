<!-- src/routes/lecturer/results/+layout.svelte -->
<script lang="ts">
  ...
  const tabs = [
    { href: '/lecturer/results', label: 'Overview' },
    { href: '/lecturer/results/by-course', label: 'By Course' },
    { href: '/lecturer/results/by-exam', label: 'By Exam' },
    { href: '/lecturer/results/grade-reports', label: 'Grade Reports' },
  ];
...
<div class="results-layout">
  <header class="results-header">
    ...
    <div class="header-actions">
      <a href="/lecturer/results/export" class="btn secondary">
