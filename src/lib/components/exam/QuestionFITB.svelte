...
<style>
  ...
  .input-section.focused { border-color: #059669; box-shadow: 0 0 0 3px rgba(16, 185, 129, 0.12); }
  ...
  .fitb-input:focus { border-color: #059669; }
  .fitb-input.has-value { border-color: #059669; background: rgba(16, 185, 129, 0.04); }
  .input-status { position: absolute; right: 1rem; width: 1.5rem; height: 1.5rem; border-radius: 50%; background: #059669; color: #fff; display: flex; align-items: center; justify-content: center; opacity: 0.5; transition: opacity 0.15s; }
